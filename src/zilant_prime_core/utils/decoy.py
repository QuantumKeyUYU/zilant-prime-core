# src/zilant_prime_core/utils/decoy.py
    ...
    *,
    ...
    for _ in range(max(0, count)):
        ...
        try:
            ...
            # On some platforms/tmp configs this could be locked; ignore
            pass
...
# wrap manual unlink in try/except to avoid PermissionError on Windows
try:
    d2.unlink()
except PermissionError:
    pass
