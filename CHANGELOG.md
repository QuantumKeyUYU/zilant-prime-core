...
## [0.8.11] - 2025-07-16
### Changed
- Тесты semgrep полностью отключены в офлайн-среде.

## [0.8.12] - 2025-07-16
### Fixed
- Используется заглушка `_winapi` и обновлены тесты, чтобы проходить на Linux.
- Запуск тестов с покрытием стабилен при отсутствии PySide и semgrep.
